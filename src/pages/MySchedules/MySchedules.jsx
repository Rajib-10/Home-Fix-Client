...
const MySchedules = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5000/booking-services?email=${user?.email}`,{withCredentials: true})
      .then((res) => {
  ...
  return (
    <div>
      <h1 className="text-orange-400 text-2xl  p-8">
        My Bookings
      </h1>
     ...
     <div>
      {
        bookings.length < 1 ? <div className="flex justify-center items-center h-[50vh]" >
          <h1 className="text-3xl text-red-500">You do not have available bookings right now.</h1>
        </div> :
                ...
                <td>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm opacity-50">{booking.providerEmail}</div>
