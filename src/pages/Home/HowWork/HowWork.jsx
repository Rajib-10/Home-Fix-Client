...
const HowWork = () => {
    return (
        <div className="py-8 bg-base-200 space-y-4 ">
            ...
            <div className="flex flex-col md:flex-row md:gap-8 lg:gap-20 items-center  lg:w-[70%] mx-auto">

                <motion.div  whileHover={{ scale: 1.10, transition: { duration: 0.3 } }}  className="bg-base-300 h-[350px] w-[250px] space-y-5  p-10  lg:p-4 xl:p-10 rounded-xl">
                ...
                <motion.div  whileHover={{ scale: 1.10, transition: { duration: 0.3 } }}  className="bg-base-300 h-[340px] w-[250px] space-y-5 p-10  lg:p-6 xl:p-10  rounded-xl">
                ...
                <motion.div  whileHover={{ scale: 1.10, transition: { duration: 0.3 } }}  className="bg-base-300 h-[340px] w-[250px] space-y-5 p-10  lg:p-5 xl:p-10  rounded-xl">
